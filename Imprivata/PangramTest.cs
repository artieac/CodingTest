    ...
    public class PangramTest : LoggableTest
    {
        ...
        public bool IsPangram(string testString)
        {
            ...
            if(testString.Length > 0)
            {
                ...
                {
                    retVal = true;
                    this.OutputLogger.WriteMessage("All 26 letters found.  The sentence is a Pangram");
                }
                else
                {
                    this.OutputLogger.WriteMessage("Only " + foundLetters.Keys.Count + " letters found.  The sentence is a Pangram");
                }
            }
            else
            {
